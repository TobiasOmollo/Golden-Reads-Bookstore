  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppShell, { children: [
    ...
    items.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center py-24 px-8 text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/book/$id", params: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: safeCoverUrl(book.cover_url || book.cover) || "/placeholder-book.png", alt: book.title, className: "w-14 h-20 rounded-lg object-cover bg-muted shrink-0", onError: (e) => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[11px] mt-1 text-gold font-bold", children: formatKES(book.price ?? 0) })
        ] })
      ] }),
