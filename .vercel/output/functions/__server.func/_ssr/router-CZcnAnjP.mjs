...
const $$splitComponentImporter$8 = () => import("./wishlist-DGNEjNix.mjs");
...
const $$splitComponentImporter$7 = () => import("./profile-BqdH7nZ3.mjs");
...
const $$splitComponentImporter$6 = () => import("./magazines-9b6C-Sks.mjs");
...
const $$splitComponentImporter$5 = () => import("./login-BjHNwBKL.mjs");
...
const $$splitComponentImporter$4 = () => import("./library-DRd5MmY6.mjs");
...
const $$splitComponentImporter$3 = () => import("./discover-oJJie9gm.mjs");
...
const $$splitComponentImporter$2 = () => import("./bulletin-C4d0BxVH.mjs");
...
const $$splitComponentImporter$1 = () => import("./index-y-vWsHpE.mjs");
...
const rawUrl = "https://readers-backend.onrender.com";
...
const api = {
  books: {
    trending: async () => {
      return get("/books/trending");
    },
    search: async (q, genre = "") => {
      return get(`/books/search?q=${encodeURIComponent(q)}&genre=${encodeURIComponent(genre)}`);
    },
    detail: async (id) => {
      return get(`/books/${id}`);
    },
    discover: async (q) => {
      return get(`/books/search?q=${encodeURIComponent(q)}`);
    },
    coverUrl: (id, openLibraryId) => openLibraryId ? `https://covers.openlibrary.org/b/id/${openLibraryId}-L.jpg` : `${BASE}/books/${id}/cover`
  },
  audio: {
    search: async (q) => {
      return get(`/audio/search?q=${encodeURIComponent(q)}`);
    },
    detail: async (id) => {
      return get(`/audio/${id}`);
    }
  ...
  ai: {
    ...
    recommend: async (genres, history) => {
      return post(`/ai/recommend`, { genres, history });
    },
...
const $$splitComponentImporter = () => import("./book._id-D7wQ9RxJ.mjs");
