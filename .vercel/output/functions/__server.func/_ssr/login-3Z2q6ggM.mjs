...
function LoginPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-background text-foreground flex flex-col", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md w-full mx-auto px-6 pt-16 pb-10 flex-1 flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.form, { initial: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { id: "email", name: "email", label: "Email", type: "email", value: email, onChange: setEmail, autoComplete: "email", invalid: shake && !email.includes("@") }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { id: "password", name: "password", label: "Password", type: show ? "text" : "password", value: pw, onChange: setPw, autoComplete: "current-password", invalid: shake && pw.length < 4, trailing: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", "aria-label": show ? "Hide password" : "Show password", onClick: () => setShow((v) => !v), className: "text-muted-foreground", children: show ? /* @__PURE__ */ jsxRuntimeExports.jsx(EyeOff, { size: 16 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Eye, { size: 16 }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-xs", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-2 text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { id: "rememberMe", name: "rememberMe", type: "checkbox", className: "rounded accent-[color:var(--color-gold)]" }),
          "Remember me"
        ] }),
...
function Field({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "block", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `mt-1.5 flex items-center gap-2 px-4 py-3 rounded-2xl bg-surface border transition-colors ${invalid ? "border-destructive" : "border-divider focus-within:border-gold"}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("input", { id, name, type, value, onChange: (e) => onChange(e.target.value), autoComplete, className: "flex-1 bg-transparent outline-none text-sm" }),
      trailing
    ] })
  ] });
}
