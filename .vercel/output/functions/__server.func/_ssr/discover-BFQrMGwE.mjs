...
import { b as Route$3, a as api } from "./router-BW1ijkCd.mjs";
...
function DiscoverPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppShell, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { layout: true, className: "grid grid-cols-[repeat(auto-fill,minmax(140px,1fr))] gap-x-4 gap-y-8 px-5 mt-6 justify-center", children: showSkeletons ? Array.from({
      length: 6
    }).map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(BookCardSkeleton, {}, i)) : books.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookCard, { book: b }) }, b.id)) }),
    !showSkeletons && books.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "px-5 mt-10 text-center text-sm text-muted-foreground", children: "No books match your search." })
  ] });
}
export {
