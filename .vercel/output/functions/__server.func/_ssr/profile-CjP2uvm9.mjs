...
import { a as useTheme, A as AppShell } from "./AppShell-BkBUfT0b.mjs";
...
const email = "amara@goldenreads.app";
const avatar = "https://i.pravatar.cc/200?img=47";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppShell, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-5 mt-4 rounded-2xl bg-gradient-to-br from-primary to-primary/80 text-primary-foreground p-5 shadow-soft", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: user.avatar, alt: "", className: "w-16 h-16 rounded-full object-cover ring-2 ring-gold/60" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-3 mt-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Mini, { label: "Goal", value: `${user.readingGoal}/yr` }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mt-6 px-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl bg-surface border border-divider divide-y divide-divider", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(LogOut, { size: 16 }), label: "Sign out", destructive: true, href: "/login" })
      ] })
    ] }),
...
function Row({
  ...
  if (href) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: href, children: inner });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "w-full text-left", children: inner });
}
export {
