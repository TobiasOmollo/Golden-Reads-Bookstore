...
import { c as Search, j as ShoppingBag, k as Sun, M as Moon, B as Bell, X, l as Menu, m as Minus, P as Plus, T as Trash2 } from "../_libs/lucide-react.mjs";
...
const navLinks = [
  ...
  { to: "/magazines", label: "Magazines & News" },
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex items-center justify-between h-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-8", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden md:flex items-center gap-6", children: navLinks.map((link) => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: isOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            exit: { height: 0, opacity: 0 },
            className: "md:hidden border-t border-divider bg-background overflow-hidden",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "px-5 py-6 flex flex-col gap-4", children: navLinks.map((link) => {
              const active = link.to === "/" ? pathname === "/" : pathname.startsWith(link.to);
