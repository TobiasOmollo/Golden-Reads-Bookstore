...
import { u as useCart, A as AppShell, f as formatKES } from "./AppShell-CnT8i_7n.mjs";
import { S as SectionHeader, B as BookRail } from "./BookRail-8hyPYXg3.mjs";
import { u as useWishlist } from "./wishlist-BmF41ml4.mjs";
import { u as useLibrary } from "./library-Czyiyke9.mjs";
import { c as Route, a as api } from "./router-adJ-8_04.mjs";
import { s as safeCoverUrl } from "./utils-xKD8UITI.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground pb-32", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: safeCoverUrl(book.cover_url || book.cover) || "/placeholder-book.png", alt: book.title ?? "Book Cover", className: "w-full h-full object-cover", onError: (e) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.section, { initial: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5 mb-3", children: (Array.isArray(book.genre) ? book.genre : Array.isArray(book.genres) ? book.genres : book.genre ? [book.genre] : []).map((g) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] uppercase tracking-wider px-2.5 py-1 rounded-full bg-gold/15 text-gold", children: g }, g)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-[26px] font-semibold leading-tight", children: book.title ?? "Untitled Book" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif italic text-[18px] text-muted-foreground mt-1", children: book.author ?? "Unknown Author" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mt-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
            Array.from({
              length: 5
            }).map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { size: 14, fill: i < Math.round(book.rating ?? 4.5) ? "currentColor" : "none", className: "text-gold", strokeWidth: 1.5 }, i)),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs ml-1", children: book.rating ?? 4.5 })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-xs", children: "· 2,431 reviews" }),
          book.download_count !== void 0 && book.download_count > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground text-xs", children: [
            "· ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-2 mt-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { size: 14 }), label: "Reading", value: String(book.readingTime ?? "120 min") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { size: 14 }), label: "Pages", value: `${book.pages ?? 300}` }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed bottom-0 inset-x-0 z-30 bg-surface/95 backdrop-blur border-t border-divider", style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-xl font-semibold text-gold", children: formatKES(book.price ?? 0) })
      ] }),
    ...
    }, activeBookId: book.id, activeBookTitle: book.title ?? "Untitled Book", textSelection: highlightedText || void 0 }),
