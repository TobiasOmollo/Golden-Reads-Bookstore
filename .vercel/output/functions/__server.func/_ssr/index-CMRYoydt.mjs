...
import { S as SectionHeader, B as BookRail } from "./BookRail-_mGj6U6a.mjs";
import { B as BookCardSkeleton } from "./BookCard-DidWKEJ7.mjs";
...
function HeroCarousel({ books }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 mt-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[16/10] rounded-2xl overflow-hidden bg-muted shadow-soft", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: book.cover, alt: "", className: "w-full h-full object-cover" }),
