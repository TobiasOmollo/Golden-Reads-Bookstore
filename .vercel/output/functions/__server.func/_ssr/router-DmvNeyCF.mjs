...
const $$splitComponentImporter$8 = () => import("./wishlist-DXdon59i.mjs");
...
const $$splitComponentImporter$7 = () => import("./profile-BE5ifZuw.mjs");
...
const $$splitComponentImporter$6 = () => import("./magazines-DTYllcd0.mjs");
...
const $$splitComponentImporter$5 = () => import("./login-BjHm4i5B.mjs");
...
const $$splitComponentImporter$4 = () => import("./library-CXaT1whC.mjs");
...
const $$splitComponentImporter$3 = () => import("./discover-DI3YtJlP.mjs");
...
const $$splitComponentImporter$2 = () => import("./bulletin-Dhl83-Ap.mjs");
...
const $$splitComponentImporter$1 = () => import("./index-CnXTQCgA.mjs");
...
const api = {
  books: {
    trending: () => get("/books/trending"),
    search: (q, genre = "") => get(`/books/search?q=${encodeURIComponent(q)}&genre=${encodeURIComponent(genre)}`),
    detail: (id) => get(`/books/${id}`),
    discover: (q) => get(`/books/search?q=${encodeURIComponent(q)}`),
...
const $$splitComponentImporter = () => import("./book._id-CVNMjmCs.mjs");
