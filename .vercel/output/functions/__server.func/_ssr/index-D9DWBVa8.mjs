...
import { A as AppShell } from "./AppShell-CnT8i_7n.mjs";
...
import { B as BookCardSkeleton } from "./BookCard-Ok4mHVHo.mjs";
import { a as api } from "./router-adJ-8_04.mjs";
import { A as AnimatePresence, m as motion } from "../_libs/framer-motion.mjs";
import { j as Star } from "../_libs/lucide-react.mjs";
...
function byGenre(books, g) {
  return books.filter((b) => {
    const genres = Array.isArray(b.genre) ? b.genre : Array.isArray(b.genres) ? b.genres : typeof b.genre === "string" ? [b.genre] : [];
...
function HomePage() {
  ...
  const sections = [{
    ...
    title: "Best Sellers",
    href: "/discover",
    books: [...books].sort((a, b) => (b.rating ?? 0) - (a.rating ?? 0)).slice(0, 10)
  }, {
    title: "New Releases",
    href: "/discover",
    ...
    title: "Audiobooks",
    href: "/discover",
    books: books.filter((b) => b.formats?.includes?.("audio") ?? false).slice(0, 10)
  }];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppShell, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4", children: books.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(HeroCarousel, { books: books.slice(0, 5) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 space-y-8", children: isLoading && books.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3 px-5", children: Array.from({
      length: 4
